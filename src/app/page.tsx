        ...
        <main className="max-w-4xl mx-auto">
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              ...
              services to our patients. Our experienced team 
              specializes in {practiceConfig.branding.focus.toLowerCase()} and is dedicated 
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Expert care in {practiceConfig.branding.focus.toLowerCase()}</p>
              </div>
            </div>
          </section>
